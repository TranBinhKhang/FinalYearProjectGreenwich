...
function AdminLessonListScreen(props) {
    ...
    return (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <ListItem
            title={item.name}
            onPress={() => props.navigation.navigate('Admin Lesson Detail', item)}
          />
          )}
        />
        <View style={{width: '98%', justifyContent: 'flex-end', alignSelf: 'center', position: 'absolute', bottom: 0}}>
            ...
            alignSelf: 'center', justifyContent: 'center', alignContent: 'center', alignItems: 'center',  marginBottom: 10}}>
                <TouchableWithoutFeedback onPress={() => props.navigation.navigate('Admin Lesson Add')}>
